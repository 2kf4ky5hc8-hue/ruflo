...
export function JobModal({
  ...
  return (
        ...
        <>
          {editable &&
            (job.archived ? (
              ...
              <button className="btn warn" onClick={() => setArchived(true)} disabled={busy}>
                Archive
              </button>
            ))}
    ...
    >
      <form id="job-form" className="form-grid" onSubmit={save}>
      ...
      <div className="meta-line muted">
        ...
        {' — '}last updated by {profileName(job.updated_by)} ·{' '}
        {dateTimeLabel(job.updated_at)}
      </div>
